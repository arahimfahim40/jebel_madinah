            ...
            <div style="clear: both;"></div>
                    <div class="row pt-1 pr-1 pl-1">
                        ...
                        <div class="col-md-6 form-group">
                            <select id='customerStatus' class="form-control" style="width: 150px !important; display: inline; height: 33px;">
                        ...
                        <div style="float: right; padding-top: 8px;">
                            <div class="text text-warning"><b>Customers</b></div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function updateVehicleList(page=0) {
        ...
        request.fail(function(jqXHR, textStatus) {
            $('#searchBody').html('');
            $('#customer_data').append(textStatus);
        });
    }
