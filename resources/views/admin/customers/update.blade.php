      ...
      <div class="container">
        ...
        <div class="wizard-v4-content w-100">
          <div class="wizard-form py-2">
            ...
            <form id="update-customer" class="px-3" action="{{ route('customers.update', $customer->id) }}"
              method="post">
              @csrf
              @method('PUT')
              <section>
                    ...
                    <div class="col-md-6">
                      ...
                      {{-- <div class="form-group">
                        ...
                        <input type="password" name="password" id="password" class="form-control"
                          value="{{ old('password', '') }}" placeholder="Enter customer password" />
                      </div> --}}
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" name="join_date" id="join_date" class="form-control"
                          value="{{ old('join_date', $customer->join_date) }}" placeholder="Join Date" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="email" name="second_email" id="second_email" class="form-control"
                          value="{{ old('second_email', $customer->second_email) }}"
                          placeholder="Enter customer second email" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="second_phone" id="second_phone" class="form-control"
                          value="{{ old('second_phone', $customer->second_phone) }}"
                          placeholder="Enter customer second phone" />
                      </div>
                    </div>
                  </div>
