                                ...
                                <div class="row" >
                                    <div class="col-md-12">
                                        <div style="display:flex; justify-content: space-between; border-top:1px solid gray;" class="pt-2">
                                            <a href="{{ route('roles.index') }}" class="btn btn-secondary btn-outline-warning " style="height: 33px; margin-top:-5px;">
                                                <i class="fa fa fa-arrow-left"></i> Back To List
                                            </a>
                                            <a href="{{ route('roles.edit',$role->id)  }}" class="btn btn-secondary btn-outline-info " style="height: 33px; margin-top:-5px;">
