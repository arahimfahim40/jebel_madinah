                    ...
                    <div class="row">
                      <div class="col-md-4 px-0">
                        <div class="col-md-12 form-group">
                          ...
                          <select {{-- onchange="onCantainerChange(this)" --}} name="customer_id" class="form-control s2s_customers" required />
                          <option value="{{ old('customer_id', '') }}" selected>{{ $customer_name }}</option>
                          </select>
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Year</label>
                      ...
                      <div class="col-md-4 px-0">
                          ...
                          <select name="point_of_loading_id" class="form-control" required>
                            ...
                            @foreach (@getLocations() as $location)
                              <option value="{{ $location->id }}"
                                {{ old('point_of_loading_id', '') == $location->id ? 'selected' : '' }}>
                                {{ $location->name }}
                              </option>
                            @endforeach
                          </select>
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <select name="ship_as" class="form-control">
                            ...
                            <option value="complete" {{ old('ship_as', '') == 'complete' ? 'selected' : '' }}>Complete
                            </option>
                            <option value="half-cut" {{ old('ship_as', '') == 'half-cut' ? 'selected' : '' }}>Half-Cut
                            </option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4 px-0">
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <input type="date" name="title_received_date" placeholder="Title Received Date"
                            class="form-control" value="{{ old('title_received_date', '') }}" />
                        </div>
                        <div class="col-md-12 form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 form-group">
                        ...
                        <input type="url" name="auction_invoice_link" placeholder="Auction Invoice (link)"
                          class="form-control" value="{{ old('auction_invoice_link', '') }}" />
                      </div>
                    </div>
                  </div>
                </section>
                      ...
                      <div class="col-md-6 px-0">
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <input type="number" name="clearance_charge" placeholder="Clearance Charge"
                            class="form-control" value="{{ old('clearance_charge', '') }}" />
                        </div>
                        <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <input type="number" name="storage_charge" placeholder="Storage Charge"
                            class="form-control" value="{{ old('storage_charge', '') }}" />
                        </div>
                        <div class="col-md-12 form-group">
