  ...
  <div class="site-content">
    <div class="content-area py-1">
      <div class="container-fluid">
        ...
        @include('errors')
        @php
          $customer_name = old('customer_id', @$vehicle->customer_id)
              ? DB::table('customers')->find(old('customer_id', @$vehicle->customer_id))->name
              : '';
        @endphp
                    ...
                    <div class="row">
                      <div class="col-md-4 px-0">
                        <div class="col-md-12 form-group">
                          ...
                          <option value="{{ old('customer_id', @$vehicle->customer_id) }}" selected>{{ $customer_name }}
                          </option>
                          </select>
                        </div>
                        <div class="col-md-12 form-group">
                      ...
                      <div class="col-md-4 px-0">
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <input type="number" name="lot_number" placeholder="Lot Number" class="form-control"
                            value="{{ old('lot_number', @$vehicle->lot_number) }}" required />
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Container Number</label>
                          <input type="text" name="container_number" placeholder="Container Number"
                            class="form-control" value="{{ old('container_number', @$vehicle->container_number) }}" />
                        </div>

                        <div class="col-md-12 form-group">
                          <label class="required">Point Of Loading</label>
                          <select name="point_of_loading_id" class="form-control" required>
                            <option value="">-- Select Point Of Loading --</option>
                            @foreach (@getLocations() as $location)
                              <option value="{{ $location->id }}"
                                {{ old('point_of_loading_id', $vehicle->point_of_loading_id) == $location->id ? 'selected' : '' }}>
                                {{ $location->name }}
                              </option>
                            @endforeach
                          </select>
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <select name="ship_as" class="form-control">
                            ...
                            <option value="complete"
                              {{ old('ship_as', $vehicle->ship_as) == 'complete' ? 'selected' : '' }}>Complete</option>
                            <option value="half-cut"
                              {{ old('ship_as', $vehicle->ship_as) == 'half-cut' ? 'selected' : '' }}>Half-Cut</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-md-4 px-0">
                        <div class="col-md-12 form-group">
                          ...
                          <input type="date" name="purchase_date" placeholder="Purchase Date" class="form-control"
                            value="{{ old('purchase_date', @$vehicle->purchase_date) }}" required />
                        </div>
                        <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <input type="date" name="pickup_date" placeholder="Pick Up Date" class="form-control"
                            value="{{ old('pickup_date', @$vehicle->pickup_date) }}" />
                        </div>

                        <div class="col-md-12 form-group">
                          <label>Deliver Date</label>
                          <input type="date" name="deliver_date" placeholder="Deliver Date" class="form-control"
                  ...
                  <div class="inner">
                    <div class="row">
                      <div class="col-md-4 px-0">
                        <div class="col-md-12 form-group">
                          ...
                          <input type="text" name="hat_number" placeholder="Hat Number" class="form-control"
                            value="{{ old('hat_number', @$vehicle->hat_number) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Title Received Date</label>
                          <input type="date" name="title_received_date" placeholder="Title Received Date"
                            class="form-control"
                            value="{{ old('title_received_date', @$vehicle->title_received_date) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Title Number</label>
                          <input type="text" name="title_number" placeholder="Title Number" class="form-control"
                            value="{{ old('title_number', @$vehicle->title_number) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Title Status</label>
                          <input type="text" name="title_status" placeholder="Title Number" class="form-control"
                      ...
                      <div class="col-md-4 px-0">
                        ...
                        <div class="col-md-12 form-group">
                          <label>Auction</label>
                          <input type="text" name="auction" placeholder="Auction" class="form-control"
                            value="{{ old('auction', @$vehicle->auction) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Auction City</label>
                          <input type="text" name="auction_city" placeholder="Auction City" class="form-control"
                      ...
                      <div class="col-md-4 px-0">
                        <div class="col-md-12 form-group">
                          ...
                          <select name="is_key" class="form-control">
                            ...
                            <option value="Yes" {{ old('is_key', $vehicle->is_key) == 'Yes' ? 'selected' : '' }}>Yes
                            </option>
                            <option value="No" {{ old('is_key', $vehicle->is_key) == 'No' ? 'selected' : '' }}>No
                            </option>
                          </select>
                        </div>
                        <div class="col-md-12 form-group">
                          <label>License plate/Tag Number</label>
                          <input type="text" name="licence_number" placeholder="License plate/Tag Number"
                            class="form-control" value="{{ old('licence_number', @$vehicle->licence_number) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                    ...
                    <div class="row">
                      <div class="col-md-6 form-group">
                        ...
                        <input type="url" name="photos_link" placeholder="Photos Link" class="form-control"
                          value="{{ old('photos_link', @$vehicle->photos_link) }}" />
                      </div>
                      <div class="col-md-6 form-group">
                        <label>Auction Invoice (link)</label>
                        <input type="url" name="auction_invoice_link" placeholder="Auction Invoice (link)"
                          class="form-control"
                    ...
                    <div class="row">
                      <div class="col-md-6 px-0">
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <input type="number" name="vehicle_price" placeholder="Vehicle Price" class="form-control"
                            value="{{ old('vehicle_price', @$vehicle->vehicle_price) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Towing charge</label>
                          <input type="number" name="towing_charge" placeholder="Towing Charge" class="form-control"
                            value="{{ old('towing_charge', @$vehicle->towing_charge) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Clearance Charge</label>
                          <input type="number" name="clearance_charge" placeholder="Clearance Charge"
                            class="form-control" value="{{ old('clearance_charge', @$vehicle->clearance_charge) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Ship Charge</label>
                          <input type="number" name="ship_charge" placeholder="Ship Charge" class="form-control"
                            value="{{ old('ship_charge', @$vehicle->ship_charge) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Storage Charge</label>
                          <input type="number" name="storage_charge" placeholder="Storage Charge"
                            class="form-control" value="{{ old('storage_charge', @$vehicle->storage_charge) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Custom Charge</label>
                          <input type="number" name="custom_charge" placeholder="Custom Charge" class="form-control"
                            value="{{ old('custom_charge', @$vehicle->custom_charge) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                          <label>TDS Charge</label>
                          <input type="number" name="tds_charge" placeholder="TDS Charge" class="form-control"
                            value="{{ old('tds_charge', @$vehicle->tds_charge) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Other Charge</label>
                          <input type="number" name="other_charge" placeholder="Other Charge" class="form-control"
                            value="{{ old('other_charge', @$vehicle->other_charge) }}" />
                        </div>
                      </div>
                      <div class="col-md-6 px-0">
                        <h4 class="px-1">Vehicle Costs On Jabal AL Madinah</h4>
                        <hr class="mx-1" />
                        <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <input type="number" name="clearance_cost" placeholder="Clearance Cost"
                            class="form-control" value="{{ old('clearance_cost', @$vehicle->clearance_cost) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <input type="number" name="tds_cost" placeholder="TDS Cost" class="form-control"
                            value="{{ old('tds_cost', @$vehicle->tds_cost) }}" />
                        </div>
                        <div class="col-md-12 form-group">
                      ...
                      <div class="col-md-12 form-group">
                        ...
                        <textarea name="invoice_description" placeholder="Invoice Description" rows="6" class="form-control">{{ old('invoice_description', @$vehicle->invoice_description) }}</textarea>
                      </div>
                    </div>
                  </div>
                </section>
