            ...
            <form id="create-vehicle-form" class="form-register form-horizontal" method="POST"
              ...
              <div>
                          ...
                          <select name="owner_id" class="form-control" required>
                            ...
                            @foreach (@getOwners() as $owner)
                              <option value="{{ $owner->id }}"
                                {{ old('owner_id', $vehicle->owner_id) == $owner->id ? 'selected' : '' }}>
                                {{ $owner->name }}
                              </option>
                            @endforeach
                          </select>
                      ...
                      <div class="col-md-4 px-0">
                        <div class="col-md-12 form-group">
                          ...
                          <select name="auction_name" class="form-control">
                            ...
                            <option value="Copart"
                              {{ old('auction_name', $vehicle->auction_name) == 'Copart' ? 'selected' : '' }}>
                              Copart
                            </option>
                            <option value="IAAI"
                              {{ old('auction_name', $vehicle->auction_name) == 'IAAI' ? 'selected' : '' }}>
                              IAAI
                            </option>
                          </select>
                        </div>
                ...
                <h2>
                  ...
                  <span class="step-text">Costs & Sold</span>
                </h2>
                <section>
                  <div class="inner">
                    <div class="row">
                          ...
                          <div class="col-md-12 form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" id="towing_cost" name="towing_cost" placeholder="Towing Cost"
                                class="form-control input-usd-cost"
                          ...
                          <div class="col-md-12 form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" id="clearance_cost" name="clearance_cost"
                                ...
                                value="{{ old('clearance_cost', $vehicle->clearance_cost) }}" />
                            </div>
                          </div>
                          <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="number" id="sold_price" name="sold_price" placeholder="Sold Price"
                              class="form-control" value="{{ old('sold_price', $vehicle->sold_price) }}" />
                          </div>
                        </div>

                        @php
                          $total_cost =
                              (old('vehicle_price', $vehicle->vehicle_price) +
                                  old('towing_cost', $vehicle->towing_cost) +
                                  old('ship_cost', $vehicle->ship_cost) +
                                  old('storage_cost', $vehicle->storage_cost) +
                                  old('custom_cost', $vehicle->custom_cost) +
                                  old('tds_cost', $vehicle->tds_cost) +
                                  old('other_cost', $vehicle->other_cost)) *
                                  3.675 +
                              old('clearance_cost', $vehicle->clearance_cost);
                        @endphp
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="number" id="total_cost" name="total_cost" placeholder="Total Cost"
                              class="form-control" value="{{ $total_cost }}" disabled />
                          </div>
                        </div>
                        <div class="col-md-12 form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="number" id="profit_and_loss" name="profit_and_loss"
                              placeholder="Profit & Loss" class="form-control"
                              value="{{ old('sold_price', $vehicle->sold_price) - $total_cost }}" disabled />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12 form-group">
